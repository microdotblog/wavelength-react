...
Use `./../inkwell-react` for login flows and general feel.

Use `./../wavelength-ios` to reference the original ios app implementation for this app.

For API and general implementation check the native web project to understand the requirements and API contracts needed for creating podcasts: './../microblog-web`.
